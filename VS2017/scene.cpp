...
Scene::Scene() {
    ...
    depthShader = Shader("../VS2017/resources/shaders/DepthVertexShader.glsl", "../VS2017/resources/shaders/DepthFragmentShader.glsl");

    // Set up depth map
    glGenFramebuffers(1, &depthMapFBO);

    //comes from the start of the learn openGL
